...
LBB3_5:
	...
	add	x8, sp, #64
	str	x8, [sp, #8]
	adrp	x0, l_alloc_71b99a1804d93c013f301ec59bc480be@PAGE
	add	x0, x0, l_alloc_71b99a1804d93c013f301ec59bc480be@PAGEOFF
	mov	w9, #1
	mov	x1, x9
	adrp	x2, l_alloc_2bfeba76c1438a46208a034153050220@PAGE
	add	x2, x2, l_alloc_2bfeba76c1438a46208a034153050220@PAGEOFF
	mov	x3, #0
	bl	__ZN4core3fmt9Arguments6new_v117hfb455dc6e2532627E
	ldr	x0, [sp, #8]
	adrp	x1, l_alloc_ffaf8578af742fcd9190283b2acd56d3@PAGE
	add	x1, x1, l_alloc_ffaf8578af742fcd9190283b2acd56d3@PAGEOFF
...
__ZN4main4main17hd0d97daef3a32cf2E:
	...
	add	x8, sp, #16
	str	x8, [sp, #8]
	adrp	x0, l_alloc_c4c9d68f37f104cd72fe358d462cc340@PAGE
	add	x0, x0, l_alloc_c4c9d68f37f104cd72fe358d462cc340@PAGEOFF
	mov	w9, #1
	mov	x1, x9
	adrp	x2, l_alloc_2bfeba76c1438a46208a034153050220@PAGE
	add	x2, x2, l_alloc_2bfeba76c1438a46208a034153050220@PAGEOFF
...
__ZN4main22on_main_print_greeting17h8d627335dcd70cdeE:
	...
	add	x8, sp, #16
	str	x8, [sp, #8]
	adrp	x0, l_alloc_26b04c951a29748b9fe1702bdeca0e3d@PAGE
	add	x0, x0, l_alloc_26b04c951a29748b9fe1702bdeca0e3d@PAGEOFF
	mov	w9, #1
	mov	x1, x9
	adrp	x2, l_alloc_2bfeba76c1438a46208a034153050220@PAGE
	add	x2, x2, l_alloc_2bfeba76c1438a46208a034153050220@PAGEOFF
...
l_alloc_09d11aa498739cbf0519d318f9792c9b:
	.ascii	"invalid args"

	.section	__DATA,__const
	.p2align	3
l_alloc_71b99a1804d93c013f301ec59bc480be:
	.quad	l_alloc_09d11aa498739cbf0519d318f9792c9b
	.asciz	"\f\000\000\000\000\000\000"

	.section	__TEXT,__const
	.p2align	3
l_alloc_2bfeba76c1438a46208a034153050220:
	.byte	0

l_alloc_e2222df79fea71f2539d68a3a6ae8b04:
	.ascii	"/rustc/84c898d65adf2f39a5a98507f1fe0ce10a2b8dbc/library/core/src/fmt/mod.rs"

	.section	__DATA,__const
	.p2align	3
l_alloc_ffaf8578af742fcd9190283b2acd56d3:
	.quad	l_alloc_e2222df79fea71f2539d68a3a6ae8b04
	.asciz	"K\000\000\000\000\000\000\000\223\001\000\000\r\000\000"

	.section	__TEXT,__const
l_alloc_16a429f18bc382a7367b7be880ae543c:
	.ascii	"[main.rs] on awake\n"

	.section	__DATA,__const
	.p2align	3
l_alloc_c4c9d68f37f104cd72fe358d462cc340:
	.quad	l_alloc_16a429f18bc382a7367b7be880ae543c
	.asciz	"\023\000\000\000\000\000\000"

	.section	__TEXT,__const
l_alloc_6edc2ae99c553c520f8c3f81b6ddd018:
	.ascii	"[on_main_print_greeting] Heyao World!!!\n"

	.section	__DATA,__const
	.p2align	3
l_alloc_26b04c951a29748b9fe1702bdeca0e3d:
	.quad	l_alloc_6edc2ae99c553c520f8c3f81b6ddd018
