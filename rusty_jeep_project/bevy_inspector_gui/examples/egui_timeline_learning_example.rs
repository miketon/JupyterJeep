// https://whoisryosuke.com/blog/2023/getting-started-with-egui-in-rust/?utm_source=pocket_saves
// Egui Learning Example
...
use bevy_inspector_egui::bevy_egui::{
    egui::{
        ...
        vec2, Color32, Painter, Pos2, Rounding, Sense, Shape, Stroke, Vec2,
    },
...
fn ui_example_system(
    ...
    _animation_players: Query<&mut AnimationPlayer, With<Name>>,
) {
...
fn _example_plot(ui: &mut egui::Ui) -> egui::Response {
